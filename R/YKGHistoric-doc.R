#' Current table of historic estimates for the Yukon-Kuskokwim River Delta (Goose) study area
#'
#' Population indices for the USFWS Region 11 Migratory Bird Management Yukon-Kuskokwim River Delta (Goose) study area.
...
#' @docType data
#'
#' @usage data(YKGHistoric)
#'
#' @format A list object with 3 data frames:
#' \describe{
#'   \item{output.table}{Data frame of observer-specific estimates for the years 1985-2019,
#'   currently 582 rows of the following 19 variables:
#'   \describe{
#'     \item{Year}{The 4-digit integer year of the survey, range from 1985 to 2019.}
...
#'     \item{area}{The character string project code (YKG - Yukon-Kuskokwim River Delta (Goose)).}
#'   }
#'   }
#'   \item{expanded.table}{Data frame of observer-specific estimates broken down to the stratum level for the years 1985-2019,
#'     currently 2328 rows of the following 40 variables:
#'   \describe{
...
#'   years 1985-2019, currently 595 rows of the following 18 variables:
#'   \describe{
#'     \item{Year}{The 4-digit integer year of the survey, range from 1985 to 2019.}
#'     \item{Species}{The 4-character code for the species represented, see \code{\link[AKaerial]{sppntable}}.}
