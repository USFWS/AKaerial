#' Current table of historic estimates for the Yukon-Kuskokwim River Delta (Duck) study area
#'
#' Population indices for the USFWS Region 11 Migratory Bird Management Yukon-Kuskokwim River Delta (Duck) study area.
...
#'     \item{area}{The character string project code (YKD - Yukon-Kuskokwim River Delta (Duck)).}
#'   }
#'   }
#'   \item{expanded.table}{Data frame of observer-specific estimates broken down to the stratum level for the years 1988-2019,
#'    with the exception of 2011, currently 10958 rows of the following 40 variables:
#'   \describe{
