#' Current table of archived input file names and locations for USFWS Region 11 Migratory Bird Management aerial surveys
#'
...
#' @docType data
#'
#' @usage data(MasterFileList)
#'
#' @format A data frame consisting of 264 rows of 7 variables:
#' \describe{
