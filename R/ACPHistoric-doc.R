#' Current table of historic estimates for the Arctic Coastal Plain study area
#'
#' Population indices for the USFWS Region 11 Migratory Bird Management Arctic Coastal Plain study area.
...
#' @docType data
#'
#' @usage data(ACPHistoric)
#'
#' @format A list object with 3 data frames:
#' \describe{
#'   \item{output.table}{Data frame of observer-specific estimates for the years 2007-2019, currently 770 rows of the following 19 variables:
#'   \describe{
#'     \item{Year}{The 4-digit integer year of the survey, range from 2007 to 2019.}
...
#'     \item{area}{The character string project code (ACP - Arctic Coastal Plain).}
#'   }
#'   }
#'   \item{expanded.table}{Data frame of observer-specific estimates broken down to the stratum level for the years 2007-2019,
#'   currently 3080 rows of the following 40 variables:
#'   \describe{
...
#'   years 2007-2019, currently 507 rows of the following 18 variables:
#'   \describe{
#'     \item{Year}{The 4-digit integer year of the survey, range from 2007 to 2019.}
#'     \item{Species}{The 4-character code for the species represented, see \code{\link[AKaerial]{sppntable}}.}
