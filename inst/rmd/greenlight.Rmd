...
```{r obs_type}
kableExtra::kable_styling(kableExtra::kable(test.unit$bad))
...
<https://github.com/cfrost3/AKaerial/tree/master/data/AK%20Aerial%20Species%20AOU%20Codes02122019.csv>
...
```{r year}
kableExtra::kable_styling(kableExtra::kable(data[test.year$bad, ]))
...
```{r month}
kableExtra::kable_styling(kableExtra::kable(data[test.month$bad, ]))
...
```{r day}
kableExtra::kable_styling(kableExtra::kable(data[test.day$bad, ]))
```
...
```{r lat}
kableExtra::kable_styling(kableExtra::kable(data[test.lat$bad, ]))
```
...
```{r lon}
kableExtra::kable_styling(kableExtra::kable(data[test.lon$bad, ])) 
```
...
```{r time}
kableExtra::kable_styling(kableExtra::kable(data[test.time$bad, ])) 
```
...
```{r delay}
kableExtra::kable_styling(kableExtra::kable(data[test.delay$bad, ])) 
```
...
```{r num}
kableExtra::kable_styling(kableExtra::kable(data[test.num$bad, ])) 
```
...
```{r code}
kableExtra::kable_styling(kableExtra::kable(data[test.code$bad, ])) 
```
