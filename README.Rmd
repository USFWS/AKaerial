...
The most likely use of AKaerial would be to take advantage of the historic tables of estimates for projects on the Arctic Coastal Plain (ACPHistoric, 2007-2023), Copper River Delta (CRDHistoric, 1986-2023), Yukon-Kuskokwim River Delta for ducks (YKDHistoric, 1988-2023) and geese (YKGHistoric, 1985-2023), and Waterfowl Breeding Population and Habitat Survey (WBPHSHistoric, 1957-2023).  AKaerial includes figure-, table-, and map-generating functions that are designed to visualize data, design files, and estimates as a quality control step as well as for the production of reports, presentations, and manuscripts.
